...
class AsyncFhirClient3:
    ...
    def action(self, action: str) -> "AsyncFhirClient3":
        """
    ...
    def action_payload(self, action_payload: Dict[str, Any]) -> "AsyncFhirClient3":
        """
    ...
    def resource(self, resource: str) -> "AsyncFhirClient3":
        """
    ...
    def id_(self, id_: Union[List[str], str]) -> "AsyncFhirClient3":
        self._id = id_
        return self

    def url(self, url: str) -> "AsyncFhirClient3":
        """
    ...
    def validation_server_url(self, validation_server_url: str) -> "AsyncFhirClient3":
        """
    ...
    def additional_parameters(self, additional_parameters: List[str]) -> "AsyncFhirClient3":
        """
    ...
    def filter_by_resource(self, filter_by_resource: str) -> "AsyncFhirClient3":
        """
    ...
    def filter_parameter(self, filter_parameter: str) -> "AsyncFhirClient3":
        """
    ...
    def page_number(self, page_number: int) -> "AsyncFhirClient3":
        """
    ...
    def page_size(self, page_size: int) -> "AsyncFhirClient3":
        """
    ...
    def last_updated_after(self, last_updated_after: datetime) -> "AsyncFhirClient3":
        """
    ...
    def last_updated_before(self, last_updated_before: datetime) -> "AsyncFhirClient3":
        """
    ...
    def sort_fields(self, sort_fields: List[SortField]) -> "AsyncFhirClient3":
        """
    ...
    def auth_server_url(self, auth_server_url: str) -> "AsyncFhirClient3":
        """
    ...
    def auth_scopes(self, auth_scopes: List[str]) -> "AsyncFhirClient3":
        """
    ...
    def login_token(self, login_token: str) -> "AsyncFhirClient3":
        """
    ...
    def client_credentials(self, client_id: str, client_secret: str) -> "AsyncFhirClient3":
        """
    ...
    def logger(self, logger: FhirLogger) -> "AsyncFhirClient3":
        """
    ...
    def adapter(self, adapter: BaseAdapter) -> "AsyncFhirClient3":
        """
    ...
    def limit(self, limit: int) -> "AsyncFhirClient3":
        """
        Limit the results
    ...
    def set_access_token(self, value: str) -> "AsyncFhirClient3":
        """
        Sets access token
    ...
    def expand_fhir_bundle(self, expand_fhir_bundle: bool) -> "AsyncFhirClient3":
        """
    ...
    def include_total(self, include_total: bool) -> "AsyncFhirClient3":
        """
    ...
    def filter(self, filter_: List[BaseFilter]) -> "AsyncFhirClient3":
        """
